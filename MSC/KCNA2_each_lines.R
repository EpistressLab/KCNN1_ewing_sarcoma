...
plot_annot <- ggplot(gtf_KCNA2,aes(xmin=start_transcript, xmax=end_transcript, y=transcript, forward = orientation)) +
...
MSC_control_input_data <- make_df_cov("./Samples/MSC1_control_input/bedgraphs/MSC1_control_input_hg38.bedGraph","chr1",110583000,110641000)
...
MSC_control_FLI1 <- make_cov_plot(MSC_control_FLI1_data,110583000,110641000,"#85d1e4",max_cov_plot) + 
  ...
  geom_rect(data=GGAA_coords, aes(xmin=start,xmax=end,ymin=0,ymax=max_cov_plot),inherit.aes=F, fill="#f2c025", alpha=0.85)
MSC_control_H3K27ac <- make_cov_plot(MSC_control_H3K27ac_data,110583000,110641000,"#85d1e4",max_cov_plot) + 
  ...
  geom_rect(data=GGAA_coords, aes(xmin=start,xmax=end,ymin=0,ymax=max_cov_plot),inherit.aes=F, fill="#f2c025", alpha=0.85)
MSC_control_input <- make_cov_plot(MSC_control_input_data,110583000,110641000,"#85d1e4",max_cov_plot) + 
...
png("./plots/KCNA2_MSC1_plasmControl.png", width = 20, height = 35, units = "cm", res = 300)
plot_control
dev.off()
...
MSC_EWSFLI1_input_data <- make_df_cov("./Samples/MSC1_EWSFLI1_input/bedgraphs/MSC1_EWSFLI1_input_hg38.bedGraph","chr1",110583000,110641000)
...
MSC_EWSFLI1_FLI1 <- make_cov_plot(MSC_EWSFLI1_FLI1_data,110583000,110641000,"#ec93a6",max_cov_plot) + 
  ...
  geom_rect(data=GGAA_coords, aes(xmin=start,xmax=end,ymin=0,ymax=max_cov_plot),inherit.aes=F, fill="#f2c025", alpha=0.)
MSC_EWSFLI1_H3K27ac <- make_cov_plot(MSC_EWSFLI1_H3K27ac_data,110583000,110641000,"#ec93a6",max_cov_plot) + 
  ...
  geom_rect(data=GGAA_coords, aes(xmin=start,xmax=end,ymin=0,ymax=max_cov_plot),inherit.aes=F, fill="#f2c025", alpha=0.85)
MSC_EWSFLI1_input <- make_cov_plot(MSC_EWSFLI1_input_data,110583000,110641000,"#ec93a6",max_cov_plot) + 
...
png("./plots/KCNA2_MSC1_plasmEWSFLI1.png", width = 20, height = 35, units = "cm", res = 300)
plot_EWSFLI1
dev.off()
...
MSC_FLI1_input_data <- make_df_cov("./Samples/MSC1_FLI1_input/bedgraphs/MSC1_FLI1_input_hg38.bedGraph","chr1",110583000,110641000)
...
MSC_FLI1_H3K27ac <- make_cov_plot(MSC_FLI1_H3K27ac_data,110583000,110641000,"#f49b70",max_cov_plot) + 
  ...
  geom_rect(data=GGAA_coords, aes(xmin=start,xmax=end,ymin=0,ymax=max_cov_plot),inherit.aes=F, fill="#f2c025", alpha=0.85)
MSC_FLI1_input <- make_cov_plot(MSC_FLI1_input_data,110583000,110641000,"#f49b70",max_cov_plot) + 
...
png("./plots/KCNA2_MSC1_plasmFLI1.png", width = 20, height = 35, units = "cm", res = 300)
plot_FLI1
dev.off()
...
png("./plots/KCNA2_MSC1.png", width = 20, height = 35, units = "cm", res = 300)
plot_grid(ggplot() + annotate("text", x = 1, y = 1, size=5, label="MSC with plasmids") + theme_void(),
            ...
            plot_annot, align = "v", axis="tb", ncol=1, nrow=8, rel_heights = c(0.06,rep(c(0.124, 0.124),3),0.25))
dev.off()